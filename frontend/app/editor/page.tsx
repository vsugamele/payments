...
export default function DocStudioEditor() {
  ...
  return (
    <div
      ...
      className="flex flex-col h-[calc(100vh-64px)] bg-slate-100/60 dark:bg-background text-foreground overflow-hidden font-sans print:h-auto print:overflow-visible print:bg-white print:text-black print:m-0 print:p-0"
    >
      ...
      <div className="flex-1 flex overflow-hidden relative print:overflow-visible print:h-auto print:block">
        ...
        <div
          ...
          className="flex-1 flex flex-col min-w-0 bg-slate-100/80 dark:bg-[#0b0f17] overflow-y-auto scroll-smooth print:overflow-visible print:h-auto print:bg-white print:p-0 print:block"
        >
